...
---|---|---|---|---|---|---
Entity creation | addEntity | 103.0 | 102.0
... | saveEntityReferenceCopy | 96.0 | 97.0
Entity search | findEntities | 52.0 | 63.0
... | findEntitiesByProperty | 32.0 | 37.0
... | findEntitiesByPropertyValue | 50.0 | 59.0
Relationship creation | addRelationship | 103.0 | 102.0
... | saveRelationshipReferenceCopy | 107.0 | 103.0
Relationship search | findRelationships | 26.0 | 30.0
... | findRelationshipsByProperty | 31.0 | 35.0
... | findRelationshipsByPropertyValue | 42.0 | 53.0
Entity classification | classifyEntity | 145.0 | 145.0
... | saveClassificationReferenceCopy | 106.0 | 94.0
Classification search | findEntitiesByClassification | 37.0 | 46.0
Entity update | reTypeEntity | 89.0 | 86.0
... | updateEntityProperties | 112.0 | 113.0
Relationship update | updateRelationshipProperties | 128.0 | 123.0
Classification update | updateEntityClassification | 169.0 | 167.5
Entity undo | undoEntityUpdate | 108.0 | 109.0
Relationship undo | undoRelationshipUpdate | 123.0 | 125.0
Entity retrieval | getEntityDetail | 15.0 | 15.0
... | getEntitySummary | 15.0 | 15.0
... | isEntityKnown | 16.0 | 15.0
Entity history retrieval | getEntityDetail | 18.0 | 18.0
... | getEntityDetailHistory | 20.0 | 19.0
Relationship retrieval | getRelationship | 17.0 | 16.0
... | isRelationshipKnown | 17.0 | 16.0
Relationship history retrieval | getRelationship | 20.0 | 18.0
... | getRelationshipHistory | 21.0 | 19.0
Entity history search | findEntities | 58.0 | 92.0
... | findEntitiesByProperty | 29.0 | 33.0
... | findEntitiesByPropertyValue | 41.0 | 55.0
Relationship history search | findRelationships | 27.0 | 34.0
... | findRelationshipsByProperty | 31.0 | 42.0
... | findRelationshipsByPropertyValue | 50.0 | 79.0
Graph queries | getEntityNeighborhood | 27.0 | 25.0
... | getLinkingEntities | 20.0 | 25.0
... | getRelatedEntities | 540.5 | 1182.5
... | getRelationshipsForEntity | 26.0 | 26.0
Graph history queries | getEntityNeighborhood | 26.0 | 25.0
... | getLinkingEntities | 21.0 | 25.0
... | getRelatedEntities | 539.0 | 1169.0
... | getRelationshipsForEntity | 24.0 | 25.0
Entity re-home | reHomeEntity | 115.0 | 102.0
Relationship re-home | reHomeRelationship | 100.0 | 95.0
Entity declassify | declassifyEntity | 133.0 | 132.0
... | purgeClassificationReferenceCopy | 123.5 | 113.0
Entity re-identify | reIdentifyEntity | 131.0 | 120.0
Relationship re-identify | reIdentifyRelationship | 126.0 | 111.0
Relationship delete | deleteRelationship | 111.0 | 99.0
Entity delete | deleteEntity | 109.0 | 104.0
Entity restore | restoreEntity | 108.0 | 96.0
Relationship restore | restoreRelationship | 109.0 | 97.0
Relationship purge | purgeRelationship | 91.0 | 82.0
... | purgeRelationshipReferenceCopy | 74.0 | 68.0
Entity purge | purgeEntity | 100.0 | 94.0
... | purgeEntityReferenceCopy | 73.0 | 70.0
...
---|---|---|---|---|---|---|---|---|---|---|---
Entity creation | addEntity | 103.0 | 440.0 | 102.0 | 463.0
... | saveEntityReferenceCopy | 96.0 | 435.5 | 97.0 | 459.0
Entity search | findEntities | 52.0 | 261.0 | 63.0 | 530.5
... | findEntitiesByProperty | 32.0 | 36.0 | 37.0 | 52.0
... | findEntitiesByPropertyValue | 50.0 | 78.0 | 59.0 | 107.0
Relationship creation | addRelationship | 103.0 | 158.0 | 102.0 | 162.0
... | saveRelationshipReferenceCopy | 107.0 | 447.0 | 103.0 | 460.0
Relationship search | findRelationships | 26.0 | 44.0 | 30.0 | 67.0
... | findRelationshipsByProperty | 31.0 | 41.0 | 35.0 | 63.0
... | findRelationshipsByPropertyValue | 42.0 | 75.0 | 53.0 | 94.0
Entity classification | classifyEntity | 145.0 | 910.0 | 145.0 | 931.0
... | saveClassificationReferenceCopy | 106.0 | 750.0 | 94.0 | 872.0
Classification search | findEntitiesByClassification | 37.0 | 614.0 | 46.0 | 1368.5
Entity update | reTypeEntity | 89.0 | 381.0 | 86.0 | 432.0
... | updateEntityProperties | 112.0 | 714.0 | 113.0 | 804.0
Relationship update | updateRelationshipProperties | 128.0 | 473.0 | 123.0 | 461.5
Classification update | updateEntityClassification | 169.0 | 1152.0 | 167.5 | 1301.5
Entity undo | undoEntityUpdate | 108.0 | -- | 109.0 | --
Relationship undo | undoRelationshipUpdate | 123.0 | -- | 125.0 | --
Entity retrieval | getEntityDetail | 15.0 | 17.0 | 15.0 | 21.0
... | getEntitySummary | 15.0 | 15.0 | 15.0 | 19.0
... | isEntityKnown | 16.0 | 17.0 | 15.0 | 20.0
Entity history retrieval | getEntityDetail | 18.0 | -- | 18.0 | --
... | getEntityDetailHistory | 20.0 | -- | 19.0 | --
Relationship retrieval | getRelationship | 17.0 | 18.0 | 16.0 | 25.0
... | isRelationshipKnown | 17.0 | 18.0 | 16.0 | 25.0
Relationship history retrieval | getRelationship | 20.0 | -- | 18.0 | --
... | getRelationshipHistory | 21.0 | -- | 19.0 | --
Entity history search | findEntities | 58.0 | -- | 92.0 | --
... | findEntitiesByProperty | 29.0 | -- | 33.0 | --
...
... | getRelatedEntities | 539.0 | -- | 1169.0 | --
... | getRelationshipsForEntity | 24.0 | -- | 25.0 | --
Entity re-home | reHomeEntity | 115.0 | 741.0 | 102.0 | 1244.0
Relationship re-home | reHomeRelationship | 100.0 | 384.5 | 95.0 | 441.0
Entity declassify | declassifyEntity | 133.0 | 1284.0 | 132.0 | 1423.0
... | purgeClassificationReferenceCopy | 123.5 | -- | 113.0 | --
Entity re-identify | reIdentifyEntity | 131.0 | 1674.0 | 120.0 | 1918.0
Relationship re-identify | reIdentifyRelationship | 126.0 | 789.0 | 111.0 | 817.0
Relationship delete | deleteRelationship | 111.0 | 384.0 | 99.0 | 394.0
Entity delete | deleteEntity | 109.0 | 714.0 | 104.0 | 767.0
Entity restore | restoreEntity | 108.0 | 778.5 | 96.0 | 919.0
Relationship restore | restoreRelationship | 109.0 | 373.0 | 97.0 | 492.0
Relationship purge | purgeRelationship | 91.0 | 128.0 | 82.0 | 172.0
... | purgeRelationshipReferenceCopy | 74.0 | 102.0 | 68.0 | 106.0
Entity purge | purgeEntity | 100.0 | 230.0 | 94.0 | 337.0
... | purgeEntityReferenceCopy | 73.0 | 239.0 | 70.0 | 229.0
