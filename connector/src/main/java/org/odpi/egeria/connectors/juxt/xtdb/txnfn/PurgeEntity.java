...
public class PurgeEntity extends AbstractTransactionFunction {
    ...
    private static final String FN = "" +
            ...
            "          deleted (.doc (" + PurgeEntity.class.getCanonicalName() + ". existing eid force))]" +
     ...
     */
    public PurgeEntity(PersistentHashMap existing,
                       String deletedEntityGUID,
                       boolean force)
            throws EntityNotKnownException, EntityNotDeletedException {
        if (existing == null) {
     ...
     * @param force if true, do not validate whether the entity is already soft-deleted but directly purge it
