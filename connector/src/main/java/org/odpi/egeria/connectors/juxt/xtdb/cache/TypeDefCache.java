...
public class TypeDefCache {
    ...
    public static InstanceType getInstanceType(TypeDefCategory category,
        ...
        if (typeDef == null) {
            throw new TypeErrorException(XtdbOMRSErrorCode.TYPEDEF_NOT_KNOWN_FOR_INSTANCE.getMessageDefinition(
        ...
        if (isValidTypeCategory(category, typeDef)) {
            ...
            throw new TypeErrorException(XtdbOMRSErrorCode.BAD_CATEGORY_FOR_TYPEDEF_ATTRIBUTE.getMessageDefinition(
                    typeName, category.getName()),
                    TypeDefCache.class.getName(),
                    methodName);
        }
    ...
    private static void cachePropertyKeywordsInType(Map<String, PropertyKeywords> propertyMap,
        ...
        if (properties != null) {
            ...
            for (TypeDefAttribute property : properties) {
                ...
                if (previous != null) {
                    throw new InvalidParameterException(XtdbOMRSErrorCode.DUPLICATE_PROPERTIES.getMessageDefinition(
