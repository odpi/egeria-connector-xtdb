...
public class DeclassifyEntityDetail extends DeclassifyEntity {
    ...
    private static final Logger log = LoggerFactory.getLogger(DeclassifyEntityDetail.class);

    public static final Keyword FUNCTION_NAME = Keyword.intern("egeria", "declassifyEntityDetail");
    private static final String CLASS_NAME = DeclassifyEntityDetail.class.getName();
    ...
    private static final String FN = "" +
            ...
            "          updated (.doc (" + DeclassifyEntityDetail.class.getCanonicalName() + ". tx-id existing eid cname))" +
     ...
     */
    public DeclassifyEntityDetail(Long txId,
                                  PersistentHashMap existing,
                                  String entityGUID,
                                  String classificationName)
            throws Exception {
        super(CLASS_NAME, METHOD_NAME, txId, existing, null, entityGUID, classificationName);
    }
    ...
    public static EntityDetail transact(XtdbOMRSRepositoryConnector xtdb,
        ...
        try {
            ...
            throw new RepositoryErrorException(XtdbOMRSErrorCode.UNKNOWN_RUNTIME_ERROR.getMessageDefinition(),
                    DeclassifyEntityDetail.class.getName(),
                    METHOD_NAME,
                    e);
        }
    }
