...
public enum CruxOMRSErrorCode implements ExceptionMessageSet {
    ...
    QUERY_TIMEOUT(400, "OMRS-CRUX-REPOSITORY-400-006",
            "The requested query against the Crux repository at {0} timed out",
            "The local server was unable to respond to the query in the time permitted (default 30s).",
            "Investigate the logs for additional information, and either attempt a more restrictive query or increase the timeout through the Crux configuration."),
    ENTITY_NOT_KNOWN(404, "OMRS-CRUX-REPOSITORY-404-001",
            "The repository does not contain any entity with the GUID {0}",
            "The Crux repository is unable to find any entity with the provided GUID.",
            "Correct the caller's code to ensure the entity being requested is one contained in the local server."),
    RELATIONSHIP_NOT_KNOWN(404, "OMRS-CRUX-REPOSITORY-404-002",
            "The repository does not contain any relationship with the GUID {0}",
            "The Crux repository is unable to find any relationship with the provided GUID.",
    ...
    CANNOT_CLOSE_RESOURCE(500, "OMRS-CRUX-REPOSITORY-500-002 ",
            "Unable to close an open Crux resource",
