...
public class CruxQueryTest {
    ...
    void testRelationshipQuery() {
        try {
            ...
            assertEquals(condition.nth(0), CruxQuery.DOC_ID, "First element of triple is expected to be the document ID symbol.");
    ...
    void testSequencingDefault() {
        try {
            ...
            assertEquals(criterion.nth(0), CruxQuery.DOC_ID, "First element of tuple is expected to be the document ID symbol.");
            assertEquals(criterion.nth(1), CruxQuery.SORT_ASCENDING, "Second element of tuple is expected to be the keyword for ascending sort.");
    ...
    void testSequencingUpdate() {
        try {
            ...
            IPersistentVector criterion = (IPersistentVector) candidate;
            assertEquals(criterion.length(), 2, "Sequencing criterion is expected to be a tuple.");
            assertEquals(criterion.nth(0), CruxQuery.UPDATE_TIME, "First element of tuple is expected to be the update time symbol.");
            assertEquals(criterion.nth(1), CruxQuery.SORT_ASCENDING, "Second element of tuple is expected to be the keyword for ascending sort.");

            validateSequencingConditions(sequencing,
                    Keyword.intern(InstanceAuditHeaderMapping.UPDATE_TIME),
                    CruxQuery.UPDATE_TIME);
            ...
            assertEquals(criterion.length(), 2, "Sequencing criterion is expected to be a tuple.");
            assertEquals(criterion.nth(0), CruxQuery.UPDATE_TIME, "First element of tuple is expected to be the update time symbol.");
            assertEquals(criterion.nth(1), CruxQuery.SORT_DESCENDING, "Second element of tuple is expected to be the keyword for descending sort.");
    ...
    void testSequencingCreate() {
        try {
            ...
            IPersistentVector criterion = (IPersistentVector) candidate;
            assertEquals(criterion.length(), 2, "Sequencing criterion is expected to be a tuple.");
            assertEquals(criterion.nth(0), CruxQuery.CREATE_TIME, "First element of tuple is expected to be the creation time symbol.");
            assertEquals(criterion.nth(1), CruxQuery.SORT_ASCENDING, "Second element of tuple is expected to be the keyword for ascending sort.");

            validateSequencingConditions(sequencing,
                    Keyword.intern(InstanceAuditHeaderMapping.CREATE_TIME),
                    CruxQuery.CREATE_TIME);
    ...
    void testSequencingProperty() {
        try {
            ...
            IPersistentVector criterion = (IPersistentVector) candidate;
            assertEquals(criterion.length(), 2, "Sequencing criterion is expected to be a tuple.");
            assertEquals(criterion.nth(0), CruxQuery.SORT_PROPERTY, "First element of tuple is expected to be the property symbol.");
            assertEquals(criterion.nth(1), CruxQuery.SORT_ASCENDING, "Second element of tuple is expected to be the keyword for ascending sort.");

            validateSequencingConditions(sequencing,
                    propertyKeyword,
                    CruxQuery.SORT_PROPERTY);
    ...
    private void validateSequencingConditions(IPersistentMap query,
        ...
        assertEquals(criteria.nth(0), CruxQuery.DOC_ID, "First property is always expected to be the document ID symbol.");
