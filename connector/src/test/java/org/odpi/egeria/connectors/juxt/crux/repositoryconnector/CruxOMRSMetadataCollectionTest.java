 ...
 */
public class CruxOMRSMetadataCollectionTest {
    ...
    private static CruxOMRSMetadataCollection mc   = null;
    ...
    CruxOMRSMetadataCollectionTest() {
        try {
            mc = (CruxOMRSMetadataCollection) connector.getMetadataCollection();
