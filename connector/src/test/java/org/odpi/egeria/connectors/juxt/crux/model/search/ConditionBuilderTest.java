...
public class ConditionBuilderTest {
    ...
    void testMultiplePropertiesConditions() {
        try {
            ...
            assertEquals(condition.nth(0), CruxQuery.DOC_ID, "Binding in the vector is expected to be the symbol for a document ID.");
    ...
    void testMultiplePropertyVariations() {
        try {
            ...
            assertEquals(vars.nth(0), CruxQuery.DOC_ID, "First element of de-structured variables is expected to be the document ID symbol.");
            ...
            condition = (IPersistentVector) piece;
            assertEquals(condition.nth(0), CruxQuery.DOC_ID, "First element of condition is expected to be the document ID symbol.");
